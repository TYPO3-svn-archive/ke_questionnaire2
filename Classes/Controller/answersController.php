...
/**
 * Controller for the answers object
 *
 * @version $Id$
...
class Tx_KeQuestionnaire2_Controller_answersController extends Tx_ExtbaseKickstarter_Scaffolding_AbstractScaffoldingController {
	
	/**
	 * @var Tx_KeQuestionnaire2_Domain_Repository_answersRepository
	 */
	...
	protected function initializeAction() {
		$this->answersRepository = t3lib_div::makeInstance('Tx_KeQuestionnaire2_Domain_Repository_answersRepository');
	}
