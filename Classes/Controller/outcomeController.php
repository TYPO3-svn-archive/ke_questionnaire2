...
class Tx_KeQuestionnaire2_Controller_outcomeController extends Tx_ExtbaseKickstarter_Scaffolding_AbstractScaffoldingController {
	
	/**
	 * @var Tx_KeQuestionnaire2_Domain_Repository_outcomeRepository
	 */
	...
	protected function initializeAction() {
		$this->outcomeRepository = t3lib_div::makeInstance('Tx_KeQuestionnaire2_Domain_Repository_outcomeRepository');
	}
