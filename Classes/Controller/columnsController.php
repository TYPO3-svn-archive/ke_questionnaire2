...
/**
 * Controller for the columns object
 *
 * @version $Id$
...
class Tx_KeQuestionnaire2_Controller_columnsController extends Tx_ExtbaseKickstarter_Scaffolding_AbstractScaffoldingController {
	
	/**
	 * @var Tx_KeQuestionnaire2_Domain_Repository_columnsRepository
	 */
	...
	protected function initializeAction() {
		$this->columnsRepository = t3lib_div::makeInstance('Tx_KeQuestionnaire2_Domain_Repository_columnsRepository');
	}
