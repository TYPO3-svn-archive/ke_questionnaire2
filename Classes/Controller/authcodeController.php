...
class Tx_KeQuestionnaire2_Controller_authcodeController extends Tx_ExtbaseKickstarter_Scaffolding_AbstractScaffoldingController {
	
	/**
	 * @var Tx_KeQuestionnaire2_Domain_Repository_authcodeRepository
	 */
	...
	protected function initializeAction() {
		$this->authcodeRepository = t3lib_div::makeInstance('Tx_KeQuestionnaire2_Domain_Repository_authcodeRepository');
	}
