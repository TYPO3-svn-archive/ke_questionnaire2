...
class Tx_KeQuestionnaire2_Controller_questionController extends Tx_ExtbaseKickstarter_Scaffolding_AbstractScaffoldingController {
	
	/**
	 * @var Tx_KeQuestionnaire2_Domain_Repository_questionRepository
	 */
	...
	protected function initializeAction() {
		$this->questionRepository = t3lib_div::makeInstance('Tx_KeQuestionnaire2_Domain_Repository_questionRepository');
	}
