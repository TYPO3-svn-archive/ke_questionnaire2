...
/**
 * Controller for the questions object
 *
 * @version $Id$
...
class Tx_KeQuestionnaire2_Controller_questionsController extends Tx_ExtbaseKickstarter_Scaffolding_AbstractScaffoldingController {
	
	/**
	 * @var Tx_KeQuestionnaire2_Domain_Repository_questionsRepository
	 */
	...
	protected function initializeAction() {
		$this->questionsRepository = t3lib_div::makeInstance('Tx_KeQuestionnaire2_Domain_Repository_questionsRepository');
	}
